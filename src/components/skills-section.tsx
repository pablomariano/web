              ...
              >
                <CardHeader>
                  <CardTitle className="flex items-center">
                    <div className={`w-10 h-10 ${config.color} rounded-md flex items-center justify-center mr-3`}>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                ...
                <div 
                  key={item.title}
                  className="text-center p-4 bg-card rounded-lg border border-border hover:border-primary/50 transition-colors duration-200"
